...
export default class Component extends DndSection {
    ...
    _refreshPageItem({element, state}) {
        ...
        // Disable scrollIntoView, it does not play well with the enva theme.
        // https://helplearning.planio.com/issues/453
        if (this.pageItem && !this.reactive.isEditing) {
            const container = sectionItem.closest('.drag-container');
            container.scrollTop = sectionItem.offsetTop - container.offsetTop;
