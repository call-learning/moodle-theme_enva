...
/**
 * Class envaprimary, and almost exact copy of the core primary class. The only difference is the size of the avatar in the user
 * menu.
 *
 * @package    theme_enva
...
class envaprimary {
    ...
    */
    public function get_user_menu(renderer_base $output): array {
        ...
        $usermenudata = [];
        $submenusdata = [];
        // This is the ONLY change in this class. The rest is a copy of the original class. It makes the image in the header bigger.
        $info = user_get_user_navigation_info($USER, $PAGE, ['avatarsize' => 100]);
