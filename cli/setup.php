...
$setupclass = new ReflectionClass('\theme_enva\setup');
...
if ($options['name'] === null) {
    cli_error('You must specify a function name to run');
}
...
if (in_array($options['name'], $possiblefunctions)) {
    ...
    cli_writeln('Called function not in the list (' . implode(',', $possiblefunctions) . ')');
}
